class ExperiencesController < ApplicationController
  ...
  private
    ...
    def experience_params
      ...
      params.require(:experience).permit(:name, :description, :price, :exp_date, :exp_time, :latitude, :longitude, :city, :image, :what_does_this_include, :things_to_remember, :max_seats )
    end
end
