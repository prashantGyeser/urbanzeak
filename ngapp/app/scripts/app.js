...
angular.module('urbanfunhunterApp').constant('I18N.MESSAGES', {
...
angular.module('urbanfunhunterApp').controller('AppCtrl', ['$scope', 'i18nNotifications', 'localizedMessages', function($scope, i18nNotifications) {
...
angular.module('urbanfunhunterApp').controller('HeaderCtrl', ['$scope', '$location', '$route', 'security', 'breadcrumbs', 'notifications', 'httpRequestTracker',
